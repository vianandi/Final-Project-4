...
import com.mbkm.project4.adapter.HistoryAdapter;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    String id_book = "", asal, tujuan, tanggal, dewasa, anak, bus, riwayat, total;
    String email;
    TextView tvNotFound;
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            hasil.add(new HistoryModel(id_book, tanggal, riwayat, total, bus, R.drawable.profileblue));
        }
        ...
        listBook.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                final String selection = hasil.get(i).getmIdBook();
